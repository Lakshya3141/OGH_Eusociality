...
struct params {
    ...
    double dMaxSplineLarvae = 500;      // max input for number of larvae in a nest
    ...
    void read_parameters_from_ini(const std::string& file_name) {
        ...
        dMaxSplineLarvae               = from_config.getValueOfKey<double>("dMaxSplineLarvae");
    ...
    float get_val(std::string s) {
        ...
        if (s == "dMaxSplineLarvae")               return dMaxSplineLarvae;
