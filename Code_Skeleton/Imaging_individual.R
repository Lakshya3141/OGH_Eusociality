# Use this code if you ran a simulation on your own terminal
# And not the cluster
...
bigBosstitle <- "IndCheck"       # Prefix to image file name
name_folder <- "output_sim"  # Simulation folder number to be chosen
...
files <- list.files(path = paste0("./", name_folder), pattern = file_pattern, full.names = TRUE)
...
basis_files <- list.files(path = paste0("./", name_folder), pattern = basis_pattern, full.names = TRUE)
# Check if files are found
...
print("SAVING PLOTS")
ggsave(paste0(folder_name,"/",bigBosstitle,"_Main.png"), mainy, height = 20, width = 5, units = "in", dpi = 300, limitsize = FALSE)
ggsave(paste0(folder_name,"/",bigBosstitle,"_BetaVals.png"), bet, height = 25, width = 5, units = "in", dpi = 300, limitsize = FALSE)
ggsave(paste0(folder_name,"/",bigBosstitle,"_Additional.png"), Addit, height = 20, width = 5, units = "in", dpi = 300, limitsize = FALSE)
ggsave(paste0(folder_name,"/",bigBosstitle,"_LastOfUs.png"), LOU, height = 25, width = 5, units = "in", dpi = 300, limitsize = FALSE)
