...
double dInitGrowthIntercept = 0.0; //Initial value of parameter a in logistic expression
double dInitGrowthSlope = 0.0; //Initial value of parameter b in logistic expression
