...
double max_gtime_evolution = 20000000.0;     // 100000.0 
double max_gtime_LastOfUs = 10000.0;  // 500;              // Maximum for last of us generation
double dMaleRemovalTime = 1000.0;         // every time unit males are removed
double dLarvalRemovalTime = 1000.0;       // every this time unit dead larvae are removed
double dOutputTimeInterval = 5000.0;      // population state output time interval
const unsigned int max_nests_evolution = 1000;    // 1000 // Maximum number of nests
const unsigned int max_nests_LastOfUs = 25;
